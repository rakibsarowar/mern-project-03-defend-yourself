                    ...
                    <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
                        <div>
                            <div className='flex flex-col text-center'>
                                <img src={img1} className="mx-auto w-20 h-20 sm:h-20" alt="logo" />
                                <h1 className='font-bold text-2xl'>Defend yourself</h1>
                            </div>
                            <p className="max-w-xs mx-auto mt-4 text-sm text-gray-600 text-center">
                                Let's defend ourselve anytime, anyplace, anywhre, anytime. Just Do it.
                            </p>
                        ...
                        <div className="grid grid-cols-1 gap-8 lg:col-span-2 sm:grid-cols-2 lg:grid-cols-4">
                            ...
                            <div>
                                ...
                                <nav className="flex flex-col mt-4 space-y-2 text-sm text-gray-500">
                                    <a className="hover:opacity-75" href> Karate </a>
                                    <a className="hover:opacity-75" href> Judo </a>
                                    <a className="hover:opacity-75" href> MMA </a>
                                    <a className="hover:opacity-75" href> Wing Chun </a>
                                    <a className="hover:opacity-75" href> Kung Fu </a>
                                </nav>
                            </div>
                            <div>
                                <p className="font-medium">
